...
from transmogrifier.programmatic.testing import PROGRAMMATIC_TRANSMOGRIFIER_INTEGRATION_TESTING  # noqa
...
class TestSetup(unittest.TestCase):
    ...
    layer = PROGRAMMATIC_TRANSMOGRIFIER_INTEGRATION_TESTING
